...
class IDokladProcessor_Database {
    ...
    public static function create_tables() {
        ...
        // Table for authorized users with individual iDoklad credentials
        ...
        $sql_logs = "CREATE TABLE $table_logs (
            ...
            idoklad_response longtext DEFAULT NULL,
    ...
    /**
     * Add new authorized user with iDoklad credentials
     */
    public static function add_authorized_user($email, $name, $idoklad_client_id = null, $idoklad_client_secret = null, $idoklad_api_url = null, $idoklad_user_id = null) {
        global $wpdb;
        $table = $wpdb->prefix . 'idoklad_users';
