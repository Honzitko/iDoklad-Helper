...
class IDokladProcessor_PDFCoAdminDebug {
    ...
    private function validate_idoklad_payload($data) {
        ...
        if ($document_number !== '') {
            ...
            $validation['warnings'][] = 'DocumentNumber missing - a per-user success counter will assign the next sequence automatically.';
            $validation['auto_fill_fields']['DocumentNumber'] = 'per_user_success_counter';
        }
