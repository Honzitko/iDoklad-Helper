...
### Added
- Filters for configuring the logger directory, log size threshold, and rotation retention.

### Changed
- Implemented automatic log rotation with graceful fallbacks when the preferred directory is not writable.

### Removed
- Deprecated placeholder for the legacy data transformer to prevent it from being inadvertently loaded.
